    ...
    private static class 六壬辨疑神煞纪要提供类
    {
        ...
        public static IEnumerable<(string, Dizhi?)> 取神煞(年月日时 年月日时)
        {
            ...
            #region 月煞
            {
                ...
                var 结果 = (Dizhi)((int)年月日时.月支 switch
                {
                    3 => 8,
                    4 => 9,
                    5 => 12,
